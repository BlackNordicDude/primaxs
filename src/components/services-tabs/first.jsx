        ...
        <>
            <div className="flex gap-10 text-[#CCC8C5]">
                <div className="flex flex-col basis-1/3 text-xl">
                    <p>
                    Помогаем компаниям увеличивать продажи и облегчаем взаимодействие с клиентами, 
                    беря задачи конструктива и архитектуры на себя. Работаем с любыми проектами 
                    деревянных домов. Проиллюстрируйте заказчику нюансы и особенности ваших 
                    профессиональных решений!
                    </p>
                    <p className="mt-4"><span className="text-2xl text-white">Стоимость: </span>от <span className="text-2xl text-white">5000</span> руб</p>
                    <p className="mb-4"><span className="text-2xl text-white">Сроки выполнения: </span>от <span className="text-2xl text-white">4</span> рабочих дней</p>
