        ...
        <>
            <div className="flex gap-10 text-[#CCC8C5]">
                <div className="flex flex-col basis-1/3 text-xl">
                    <p>
                    Клиенты просят рассчитать стоимость строительства дома? 
                    Делегируйте задачу профессионалам! Рассчитаем необходимый 
                    бюджет и объем пиломатериала, красиво оформим — а вам останется 
                    только презентовать проект клиенту.
                    </p>
                    <p className="mt-4"><span className="text-2xl text-white">Стоимость: </span> <span className="text-2xl text-white">100</span> руб за м<sup>2</sup></p>
