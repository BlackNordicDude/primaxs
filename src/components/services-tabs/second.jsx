        ...
        <>
            <div className="flex gap-10 text-[#CCC8C5]">
                <div className="flex flex-col basis-1/3 text-xl">
                    <p>
                    Сократите цикл сделки, заказав и выставив на сайте 3D планы. 
                    Это поможет клиенту оценить масштаб объекта, поиграть с вариантами 
                    расстановки мебели — и тем самым значительно сэкономить время.
                    </p>
                    <p className="mt-4"><span className="text-2xl text-white">Стоимость: </span> <span className="text-2xl text-white">50</span> руб за м<sup>2</sup></p>
