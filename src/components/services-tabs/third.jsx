        ...
        <>
            <div className="flex gap-10 text-[#CCC8C5]">
                <div className="flex flex-col basis-1/3 text-xl">
                    <p>
                    Пора обновить каталог проектов на сайте? Или хотите 
                    сэкономить время себе и клиенту, наглядно продемонстрировав 
                    все возможные визуальные решения? Мы готовы помочь! В кратчайшие 
                    сроки создадим 3D визуализацию по вашему запросу. 
                    </p>
                    <p className="mt-4"><span className="text-2xl text-white">Стоимость: </span>от <span className="text-2xl text-white">2000</span> руб</p>
                    <p className="mb-4"><span className="text-2xl text-white">Сроки выполнения: </span>от <span className="text-2xl text-white">2</span> рабочих дней</p>
